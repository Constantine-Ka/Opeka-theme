...
<head>
	...
	<link rel="shortcut icon" href="<?echo(get_template_directory_uri())?>/img/favicon.png" type="image/png">
<!-- 	<script src="https://cdn.jsdelivr.net/npm/vue@3.2.37/dist/vue.esm-browser.prod.min.js"></script> -->
	<?php wp_head(); ?>
</head>

<body <?php body_class(); ?> style='background-color:#fff'>
<?php wp_body_open(); ?>
<div id="page" class="site" style="margin-top:31px">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'opeka-theme' ); ?></a>
	<!--site navigator-->
	<nav id='opekaNavbar' class="topnav">
		 <a href='<? echo home_url(); ?>'><img src="/wp-content/themes/opeka-theme/img/icon.png" alt="Логотип АНО Опека"></a>
	...
	<header id="header" class="site-header">
		<!--<img src="<?php //echo get_header_image(); ?>" alt="<?php //echo get_bloginfo('title'); ?>">         Разблокировать если нужно будет вывести изображение, код в SVG убрать-->  

		<svg id="layer_1" data-name="layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 783.18 245.32">
    <defs>
        <style>
            .cls-1,
            .cls-10,
