...
class My_Walker_Nav_Menu extends Walker_Nav_Menu {
	...
	function start_lvl(&$output, $depth = 0, $args = NULL) {
		// Зависимость классов от вложенности
		$indent = ( $depth > -1  ? str_repeat( "\t", $depth ) : '' ); // отступ кода
		$display_depth = ( $depth + 1); // Потому что первый элемент подменю равен нулю
		$classes = array(		//Массив с классами
			'sub-menu',
