...
//	function start_lvl(&$output, $depth) {
	...
	// function start_el( &$output, $item, $depth = 0, $args = NULL, $id = 0 ) {
		...
		$item_output .= '<a style=color:red'. $attributes .'>';
...
?>
			...
			<?php
			$nav_args = array(
			  'theme_location' => 'menu-1',      //определяем область темы где будет размещаться главное меню
			  'container' => 'nav',                    //определяем родительский элемент (тег <nav>)
			  'container_class' => 'topnav', //назначаем имя класса для родительского элемента (тег <nav>)
			  'menu_class' => '',       //назначаем имя класса для меню (тег <ul>)
				'container_id'    => 'opekaNavbar',
				'menu_class'      => 'topnav',
				'menu_id'         => 'opekaNavbar',
				'echo'            => true,
				'fallback_cb'     => '',
